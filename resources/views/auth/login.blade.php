    ...
    <div class="mx-auto grid max-w-5xl gap-6 lg:grid-cols-2 lg:items-center">
        <section>
            ...
            <p class="mt-3 max-w-lg text-sm text-brand-100 sm:text-base">
                Acompanhe receita, despesa e resultado por caminhao em uma rotina simples para o dia a dia da
                transportadora.
            </p>
        </section>
            ...
            <form method="POST" action="{{ route('login.attempt') }}" class="mt-6 space-y-4">
                ...
                <label class="inline-flex items-center gap-2 text-sm text-slate-600">
                    <input type="checkbox" name="remember" value="1"
                        class="h-4 w-4 rounded border-slate-300 text-brand-700 focus:ring-brand-500/30"
