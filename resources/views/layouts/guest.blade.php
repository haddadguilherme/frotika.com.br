        ...
        <header class="border-b border-white/20 backdrop-blur-sm">
            <div class="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
                <a href="{{ route('welcome') }}" class="inline-flex items-center gap-3">
                    <span class="inline-flex h-9 w-9 items-center justify-center rounded-md bg-accent-500 text-sm font-display font-semibold text-brand-950">
                        F
                    </span>
                ...
                <nav class="flex items-center gap-2">
                    ...
                    @else
                        <x-ui.link-button href="{{ route('login') }}" variant="ghost" size="sm" class="text-white hover:bg-white/10">
                            Entrar
                        </x-ui.link-button>
